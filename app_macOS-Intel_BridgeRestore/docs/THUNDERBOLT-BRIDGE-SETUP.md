...
---
Generated: 2026-03-27 | OpenClaw / OCLP 3.0.0 project## NOTE â€” Session 4 Update (2026-03-27)

Desktop Commander MCP is now installed and running on the Mac mini.
When Claude is accessed from the Mac mini browser, it has direct shell access to the
mini WITHOUT needing the tunnel at all. The tunnel is only needed for MBPâ†’mini access.

Use the tunnel when working from MBP. Skip it entirely when working from mini.
